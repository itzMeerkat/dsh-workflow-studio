...
| [`src/client/WorkflowSettings.tsx`](src/client/WorkflowSettings.tsx) | The workflow settings panel: description, language, atom folder, inputs and outputs |
